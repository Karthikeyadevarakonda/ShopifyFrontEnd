...
const Footer = () => {
  ...
  const footerBg = theme === "dark" ? "bg-gray-800" : "bg-gray-100";
  const footerText = theme === "dark" ? "text-white" : "text-gray-900";
  ...
  return (
    ...
    >
      ...
      {/* Footer Bottom */}
      <div className="mt-8 border-t border-gray-300 dark:border-gray-700 pt-4 text-center text-sm opacity-70">
        <p>
